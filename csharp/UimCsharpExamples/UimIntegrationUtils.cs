...
namespace Utils
{
    class UimIntegrationUtils
    {
        ...
        public string getRegistrationItems(string appId)
        {
            WebClient webClient = new WebClient();
            webClient.Headers.Add("Accept", "application/vnd.rb.uim-v16+json");
            webClient.Headers.Add("Application-Id", appId);
            return webClient.DownloadString(uimUrl("/api/application/registration-items"));
        }
    }
}